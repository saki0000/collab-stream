...
| コマンド | 説明 |
|---------|------|
| `./scripts/safe-gradlew.sh :server:run` | Ktor サーバー起動（ポート 8080） |
| `./scripts/safe-gradlew.sh :composeApp:assembleDebug` | Android APK ビルド |
| `./scripts/safe-gradlew.sh test` | 全テスト実行 |
